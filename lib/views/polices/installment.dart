...
class InstallmentPolicyView extends StatefulWidget {
  const InstallmentPolicyView({super.key});

  @override
  State<InstallmentPolicyView> createState() => _InstallmentPolicyViewState();
}

class _InstallmentPolicyViewState extends State<InstallmentPolicyView> {
      ...
      body: Column(
        ...
        children: [
          ...
          FutureBuilder<Map<String, dynamic>>(
              future: InstallmentController.instance.checkInstallment(),
                    ...
                    children: [
                      ...
                      Visibility(
                        ...
                        child: Button(
                          ...
                          onPressed: () {
                            Get.toNamed('/installment/devices');
                          },
                        ),
                      ),
                    ],
